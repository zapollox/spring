...
----
	@WebAppConfiguration
	@ContextHierarchy({
		@ContextConfiguration(classes = com.AppConfig.class),
...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from "/com.AppConfig.groovy" and
	// "/TestConfig.groovy" in the root of the classpath
	**@ContextConfiguration({"/com.AppConfig.groovy", "/TestConfig.Groovy"})**
	public class MyTest {
		// class body...
	}
----
...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from com.AppConfig and TestConfig
	**@ContextConfiguration(classes = {com.AppConfig.class, TestConfig.class})**
	public class MyTest {
		// class body...
	}
----
